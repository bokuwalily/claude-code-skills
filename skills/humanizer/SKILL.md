<!-- source: github-scout | repo: blader/humanizer | url: https://github.com/blader/humanizer | adopted: 2026-06-10 -->
<!-- vetted: md-only(スクリプト/hook無し)・外部送信なし・Write/Edit権限は文章編集用途で正当。/scout-promote 経由で全文再取得し有効化 -->
---
name: humanizer
version: 2.8.0
description: |
