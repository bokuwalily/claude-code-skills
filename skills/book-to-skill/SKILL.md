<!-- source: github-scout | repo: virgiliojr94/book-to-skill | url: https://github.com/virgiliojr94/book-to-skill | adopted: 2026-06-10 -->
<!-- review-reason: has_script=true（scripts/tools同梱）+ allowed-tools に Bash/Write/shell_command。文書変換でローカル実行が走るため要レビュー -->
---
name: book-to-skill
